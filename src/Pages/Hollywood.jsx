...
export default function Hollywood() {
  ...
  useEffect(() => {
    fetch("https://node-blog-backend-final-5ln4.vercel.app/hollywoodPost")
      .then((res) => res.json())
      .then((json) => setPost(json));
  }, []);

  useEffect(() => {
    fetch("https://node-blog-backend-final-5ln4.vercel.app/hollywoodFirstPost")
      .then((res) => res.json())
      .then((json) => setFirstPost(json));
  }, []);

  useEffect(() => {
    fetch("https://node-blog-backend-final-5ln4.vercel.app/hollywoodTopPost")
      .then((res) => res.json())
