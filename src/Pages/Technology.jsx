...
export default function Technology() {
  ...
  useEffect(() => {
    fetch("https://node-blog-backend-final-5ln4.vercel.app/technologyPost")
      .then((res) => res.json())
      .then((json) => setPost(json));
  }, []);

  useEffect(() => {
    fetch("https://node-blog-backend-final-5ln4.vercel.app/technologyFirstPost")
      .then((res) => res.json())
      .then((json) => setFirstPost(json));
  }, []);

  useEffect(() => {
    fetch("https://node-blog-backend-final-5ln4.vercel.app/technologyTopPost")
      .then((res) => res.json())
