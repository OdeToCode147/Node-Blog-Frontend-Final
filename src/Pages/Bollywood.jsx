...
export default function Bollywood() {
  ...
  useEffect(() => {
    fetch("https://node-blog-backend-final-5ln4.vercel.app/bollywoodPost")
      .then((res) => res.json())
      .then((json) => setPost(json));
  }, []);

  useEffect(() => {
    fetch("https://node-blog-backend-final-5ln4.vercel.app/bollywoodFirstPost")
      .then((res) => res.json())
      .then((json) => setFirstPost(json));
  }, []);

  useEffect(() => {
    fetch("https://node-blog-backend-final-5ln4.vercel.app/bollywoodTopPost")
      .then((res) => res.json())
