...
export default function Food() {
  ...
  useEffect(() => {
    fetch("https://node-blog-backend-final-5ln4.vercel.app/foodPost")
      .then((res) => res.json())
      .then((json) => setPost(json));
  }, []);

  useEffect(() => {
    fetch("https://node-blog-backend-final-5ln4.vercel.app/foodFirstPost")
      .then((res) => res.json())
      .then((json) => setFirstPost(json));
  }, []);

  useEffect(() => {
    fetch("https://node-blog-backend-final-5ln4.vercel.app/foodTopPost")
      .then((res) => res.json())
